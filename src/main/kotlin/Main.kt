...
fun main() {
    ...
    val novoJogo = Jogo(
        ...
        titulo = "Batman: Arkham Asylum Game of the Year Edition") // forma diferente de passar os atributos para o construtor, sem seguir a ordem na qual foi declarada na classe Jogo.
